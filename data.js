    ...
    // ---------------------------------------------------------
    {
      ...
      categories: [
        ...
        },
        {
          name: "Word Play 🔤",
          clues: [
            { value: 100, clue: "Rearrange the letters of LISTEN to spell another common six-letter word.", answer: "Silent (also enlist / tinsel)" },
            { value: 200, clue: "Rearrange the letters of RESCUE to spell a word meaning to make safe.", answer: "Secure" },
            { value: 300, clue: "Unscramble ANLDEGN to name a country.", answer: "England" },
            { value: 400, clue: "Rearrange the letters of DECIMAL to spell a word meaning relating to medicine.", answer: "Medical" },
            { value: 500, clue: "\"Eleven plus two\" is a famous anagram of what other number phrase (both equal 13)?", answer: "Twelve plus one" },
          ],
        },
        {
          name: "Geography 🌍",
    ...
    // ---------------------------------------------------------
    {
      ...
      categories: [
        ...
        },
        {
          name: "futty ⚽",
          clues: [
            { value: 200,  clue: "Which country won the 2022 FIFA World Cup?", answer: "Argentina" },
            { value: 400,  clue: "Which club has won the most UEFA Champions League titles?", answer: "Real Madrid" },
            { value: 600,  clue: "Which two clubs share the San Siro stadium in Milan?", answer: "Inter Milan and AC Milan" },
            { value: 800,  clue: "Which country has won the most FIFA World Cup titles?", answer: "Brazil (5)" },
            { value: 1000, clue: "Which manager has won the most Premier League titles?", answer: "Sir Alex Ferguson (13)" },
          ],
        },
      ],
    },
